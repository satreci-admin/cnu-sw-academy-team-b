...
class JobDescriptorApiControllerTest {
    ...
    void findByIdInvalidIdReturnNotFoundTest() throws Exception {
        // Given
        Long id = 142L;
    ...
    void saveInvalidRobotReturnNotFoundTest() throws Exception {
        // Given
        given(jobDescriptorService.save(any(JobDescriptorSaveRequestDto.class)))
    ...
    void updateInvalidJobDescriptorOrRobotReturnNotFoundTest() throws Exception {
        // Given
        Long id = 444L;
        JobDescriptorUpdateRequestDto jobDescriptorUpdateRequestDto =
                JobDescriptorUpdateRequestDto.builder()
    ...
    void deleteInvalidJobDescriptorReturnNotFoundTest() throws Exception {
        // Given
        Long id = 444L;
    ...
    void executeInvalidJobDescriptorOrEmptyRobotReturnNotFoundTest() throws Exception {
        // Given
        Long id = 444L;
